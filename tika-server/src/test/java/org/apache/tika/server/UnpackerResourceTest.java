...
public class UnpackerResourceTest extends CXFTestBase {
    ...
    private static final String JPG_NAME = "image00001.jpg";
    ...
    private static final String JPG2_NAME = "image00002.jpg";
    ...
    private static final String DOCX_IMAGE1_NAME = "image00001.jpeg";
    private static final String DOCX_IMAGE2_NAME = "image00002.jpeg";
    ...
    public void testPDFImages() throws Exception {
        ...
        String md5 = results.get("image00000.png");
        assertTrue(
                //pre Java 11
