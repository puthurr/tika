...
abstract class AbstractPOIFSExtractor {
    ...
    protected void handleEmbeddedResource(TikaInputStream resource, String filename,
        ...
        handleEmbeddedResource(0, resource, filename, relationshipID, null, mediaType, xhtml, outputHtml);
    }
    ...
    protected void handleEmbeddedResource(int sourceId, TikaInputStream resource, String filename,
                                          ...
                                          boolean outputHtml)
            throws IOException, SAXException, TikaException {
        handleEmbeddedResource(sourceId, resource, filename, relationshipID, null, mediaType, xhtml, outputHtml);
    }
    ...
    protected void handleEmbeddedResource(TikaInputStream resource, Metadata embeddedMetadata, String filename,
                                          ...
                                          boolean outputHtml)
            throws IOException, SAXException, TikaException {
        handleEmbeddedResource(0, resource, embeddedMetadata,filename,relationshipID,storageClassID,mediaType,xhtml,outputHtml);
    }

    protected void handleEmbeddedResource(int sourceId, TikaInputStream resource, Metadata embeddedMetadata, String filename,
            String relationshipID, ClassID storageClassID, String mediaType, XHTMLContentHandler xhtml,
    boolean outputHtml)
        throws IOException, SAXException, TikaException {
    ...
    protected void handleEmbeddedOfficeDoc(int sourceId,
        ...
        if (dir.hasEntry("Package")) {
            ...
            try (TikaInputStream stream = TikaInputStream.get(
                ...
                handleEmbeddedResource(sourceId, stream, null, dir.getName(), dir.getStorageClsid(), type.toString(), xhtml, true);
                return;
            }
        }
